...
<style>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav text-uppercase mt-3 mt-sm-0">
                                ...
                                <li class="nav-item me-4">
                                    <a class="nav-link px-4 px-sm-3 active" href="events">Events</a>
                                </li>
                                <li class="nav-item me-4">
    ...
    <div id="site-hero">
        <div class="container">
            <div class="col-12">
                <h1 class="display-4 text-light text-uppercase">Events</h1>
            </div>
        </div>
	</div>
    <!-- Site Hero End -->
		...
		<div class="container py-3">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-3">
                            <img src="./dist/img/centro-logo-sm.png" class="w-100" alt="">
                        </div>
